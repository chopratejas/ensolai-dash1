        ...
        <section className="text-center mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-800 rounded-lg p-8 shadow-lg border-2 border-purple-500">
              ...
              <ul className="text-left mb-6">
                <li className="flex items-center mb-2"><Zap className="h-5 w-5 text-purple-400 mr-2" /> All Basic Plan features</li>
                <li className="flex items-center mb-2"><Zap className="h-5 w-5 text-purple-400 mr-2" /> Journal Review opportunities</li>
                <li className="flex items-center mb-2"><Zap className="h-5 w-5 text-purple-400 mr-2" /> Podcast and Media opportunities</li>
                <li className="flex items-center"><Zap className="h-5 w-5 text-purple-400 mr-2" /> Advanced analytics and reporting</li>
              </ul>
              <CTAButton>Join Waitlist <ArrowRight className="ml-2 h-5 w-5" /></CTAButton>
